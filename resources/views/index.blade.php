    ...
    <main class="home">
        ...
        <section class="about">
            ...
            <div class="left">
                ...
                <h2 style="color: #5605a1">Design</h2>
                <p style="color: gray">Desgins are admirable when the right tools and attention to details are observed. I present both of these in my quest to satisfy my clients (~_^). I commit to the best User experience while staying fashionable.</p>
            </div>
           
            <div style="color: gray" class="right">
                ...
                <h2 style="color: #5605a1">Engineering</h2>
                <p style="color: gray">Using HTML, CSS, JavaScript, PHP, and SQL makes nothing impossible to achieve. I am equipped with the right tools to develop fast, resilient solutions, the best performance for scalable projects. Best at PHP, Laravel Framework, JavaScript, React and Vue.</p>
            </div>
        </section>
        <!-- /ABOUT -->
        ...
        <section class="message">
            ...
            <div class="section-message-form">
                <form action="https://formsubmit.co/hello@nassifinnovations.com" method="POST">
                    <div class="field">
